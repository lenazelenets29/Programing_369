...
# Тема: ООП. Перевантаження операторів
## Вимоги:
...
- Індивідуальне завдання: 
   - Перевантажити оператори присвоюванння, порівняння, введення/виведення 
...
- *Опис логічної структури функції `to_string`*: 
   ...
   ![enter image description here](drawings/lab25.png)

## Варіанти використання програми:
- Реалізація перегрузки операторів(рис.2)
...
## Висновок:
На цій лабораторній роботі ми навчилися працювати з перегруженими операторами.
